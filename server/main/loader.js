...
const Loader = function (logger, configMain) {
  ...
  this.handleConfigs = function () {
    ...
    if (fs.existsSync(normalizedPath + "alterdot.js")) {
      config = require(normalizedPath + "alterdot.js");
      ...
      throw new Error(
        "Unable to find alterdot.js file. Read the installation/setup instructions"
      );
    }
    return config;
  };
