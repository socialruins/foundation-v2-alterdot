...
const Manager = function (config, configMain) {
  ...
  this.handleShare = function (jobId, client, submission) {
    ...
    const headerDigest = Algorithms.argon2d16000.hash();
    ...
    const shareMultiplier = Algorithms.argon2d16000.multiplier;
    const shareDiff =
      (Algorithms.argon2d16000.diff / Number(headerBigInt)) * shareMultiplier;
    const blockDiffAdjusted =
      job.difficulty * Algorithms.argon2d16000.multiplier;
